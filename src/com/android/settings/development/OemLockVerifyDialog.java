 ...
 * Copyright 2019-2023 Fairphone B.V.
 *
...
public class OemLockVerifyDialog extends InstrumentedDialogFragment
    ...
    public static void show(Fragment host) {
        ...
        if (manager.findFragmentByTag(TAG) == null) {
            final OemLockVerifyDialog dialog = new OemLockVerifyDialog();
