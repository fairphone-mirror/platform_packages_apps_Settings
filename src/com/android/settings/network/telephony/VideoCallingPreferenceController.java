...
public class VideoCallingPreferenceController extends TelephonyTogglePreferenceController implements
    ...
    public int getAvailabilityStatus(int subId) {
        ...
        // add by T2M.dengxiangyu for 4R-61 2021-04-14 end
        //[BUG]-Modify-End by shaopan.tang
        return SubscriptionManager.isValidSubscriptionId(subId)
                && isVideoCallEnabled(subId) && vtToggleShow //[BUG]-Modify by shaopan.tang 2024-01-22 5U-163 Carrier video calling option display obnormal when switch 4G calling
                ? AVAILABLE
