...
public class ModuleDeviceInfo extends Activity {
    ...
    private void showAllDeviceInfo() {
        ...
        mTvFinger.setText("Fingerprint info : \n" + readFingerInfo());
    ...
    private String readRam() {
        String model =
                readHwInfo(
                        "sys/devices/platform/soc/1d84000.ufshc/host0/target0:0:0/0:0:0:49476/model");
        String brand =
                readHwInfo(
                        "sys/devices/platform/soc/1d84000.ufshc/host0/target0:0:0/0:0:0:49476/vendor");
