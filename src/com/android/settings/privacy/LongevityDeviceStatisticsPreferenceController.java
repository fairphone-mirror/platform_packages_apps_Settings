...
/** {@link PreferenceControllerMixin} that navigates to settings for Longevity and device statistics */
public class LongevityDeviceStatisticsPreferenceController extends AbstractPreferenceController
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        final Intent intent = new Intent()
            .setComponent(new ComponentName("com.fairphone.activator", "com.fairphone.activator.ui.ActivationSettingsActivity"));
