    ...
    public boolean setChecked(boolean isChecked) {
        ...
        for (String animationPreference : TOGGLE_ANIMATION_TARGETS) {
            allAnimationSet &= Settings.Global.putFloat(mContentResolver, animationPreference,
                    newAnimationValue);
            if (Settings.Global.WINDOW_ANIMATION_SCALE.equals(animationPreference)) {
                SystemProperties.set("persist.sys.window.animation.scale",Float.toString(newAnimationValue));
            } else if (Settings.Global.TRANSITION_ANIMATION_SCALE.equals(animationPreference)) {
                SystemProperties.set("persist.sys.transition.animation.scale",Float.toString(newAnimationValue));
            } else if (Settings.Global.ANIMATOR_DURATION_SCALE.equals(animationPreference)) {
                SystemProperties.set("persist.sys.animator.duration.scale",Float.toString(newAnimationValue));
            }
        }
