...
class RegulatoryInfoDisplayActivity : Activity() {
    val sRegulatoryUrl = "https://techsupport.fairphone.com/labels/FP6_e-Label.png";
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(image != null) {
            Glide.with(this).load(sRegulatoryUrl).error(R.drawable.regulatory_info_fp6).into(image);
        }
        /**
